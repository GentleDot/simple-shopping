...
# 추가 및 보완 사항 적용
## Swagger UI 적용
- 적용 계기 : app의 request와 response에 대한 정보는 Spring REST Docs.로 정리가 되었지만 실제 구동시의 동작 확인에 대해서는 직접 입력하면서 확인할 수 있는 방법이 있으면 좋겠다는 생각에 적용하였습니다.
- 적용 방법 등에 대해서는 Notion에서 확인 가능하며, readme에는 간략한 과정만 정리해둘 예정입니다.